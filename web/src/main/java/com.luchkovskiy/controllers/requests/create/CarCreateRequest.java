...
public class CarCreateRequest {
    ...
    @Max(220)
    @Min(150)
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "210.5", type = "Float", description = "Maximum car's speed")
    ...
    @NotNull
    @Min(1)
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "1", type = "Long", description = "Id of the class level in database")
    private Long classId;

    @NotNull
    @Min(3)
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "7.5", type = "Float", description = "Fuel consumption per 100 km in average")
    private Float gasConsumption;

    @Pattern(regexp = "^[1-9]{4} [АВЕКМНОРСТУХABEIKMHOPCTYX]{2}-[1-7]")
    @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "1234 AX-3", type = "String", description = "License plate number of the car")
